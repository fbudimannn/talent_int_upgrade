DECLARE benchmark_ids ARRAY<STRING> DEFAULT ['EMP100012','EMP100524','EMP100548'];
...
-- =================================================================================
source_data AS (
    SELECT * FROM `celtic-facility-344813.dbt_prod.int_employees_unpivoted`
    WHERE tv_name IN (
...
LEFT JOIN `celtic-facility-344813.dbt_prod.stg_employees` e -- Pastikan join ke metadata employee
